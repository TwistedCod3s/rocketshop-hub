...
const categories = [
  {
    ...
    description: "Ready-to-fly model rockets for all skill levels",
  ...
  },
  {
    name: "Kits",
    path: "/category/kits",
    description: "Complete rocketry kits for classroom settings",
    image: "/public/placeholder.svg",
    color: "bg-indigo-50",
  ...
  },
  {
    ...
    description: "Engines, recovery systems, and more",
    image: "/public/placeholder.svg",
    color: "bg-purple-50",
